...
import { AboutList, AboutBottom } from './models';

@Injectable()
export class AboutService {
  private sanitizer = inject(DomSanitizer);
  
  readonly aboutList: AboutList[] = [
    {
  ...
  readonly aboutBottom: AboutBottom[] = [
    {
  ...
  readonly contentPicture: string =
